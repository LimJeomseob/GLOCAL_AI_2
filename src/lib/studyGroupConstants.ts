...
//
// 예외: 신청기간의 시작일만 공문의 9. 9.(수)이 아니라 9. 7.(월)이다. 시스템이 먼저 준비되어
// AI융합원이 접수를 이틀 앞당기기로 했다(2026. 9. 7. 결정). 마감일은 공문과 같다.
// 실제 접수 허용 구간의 정본은 study_rounds.expert_apply_open_at/close_at이며(0020),
...
export const STUDY_EXPERT_CONSENT_ITEMS = [
  "수집 항목: 성명·소속·직급·직번·연락처·이메일·교원 구분, 생성형 AI 활용 교수법/연구 경험, 지도 가능 카테고리, 주요 활용 AI 도구",
